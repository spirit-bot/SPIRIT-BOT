...
module.exports = {
    ...
    SESSION: process.env.SPIRITBOT_CODE === undefined ? '' : process.env.SPIRITBOT_CODE,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖spirit💖' : process.env.OWNER_NAME,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By spiritbot' : process.env.ALL_CAPTION,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'SPIRIT BOT' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ SPIRIT BOT ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'SPIRIT BOT' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'spirit🎗️/💝/✨/📝' : process.env.CMD_LIST,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Note this' : process.env.TAG_HEADER,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '919605741366,0,917994093863,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
